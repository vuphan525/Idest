        ...
        <div className="relative w-full h-full bg-black overflow-hidden">
          ...
          <div className="relative z-20 h-full flex flex-col">
            ...
            <header className="flex items-start justify-between px-6 pt-6 sm:px-10 sm:pt-9">
              ...
              />
              <div className={`${anton.className} text-white/80 text-xl sm:text-2xl font-bold`}>
                {currentTime}
              </div>
            </header>
            ...
            <div className="px-6 sm:px-10 pt-12 sm:pt-16 md:pt-20 flex flex-col items-center justify-start gap-6 sm:gap-8">
              <h1 className={`${anton.className} font-bold mx-auto max-w-5xl text-center leading-[1.02] tracking-tight text-[#FF6B35] select-none text-[34px] sm:text-[54px] md:text-[68px] lg:text-[84px]`}>
